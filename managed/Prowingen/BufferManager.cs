...
namespace Prowingen
{
	...
	{
		static ConcurrentBag<byte[]> _bag = new ConcurrentBag<byte[]> ();

		public static byte[] GetBuffer()
		{
			byte[] rv;
			if (_bag.TryTake (out rv))
				return rv;
		...
		//Code from, Apache licensed
		//https://raw.githubusercontent.com/Microsoft/referencesource/9da503f9ef21e8d1f2905c78d4e3e5cbb3d6f85a/System/sys/system/collections/concurrent/ConcurrentBag.cs
