...
struct IResponse : public IUnknown
{
    virtual HRESULT SetCode(int code, char* status) = 0;
    virtual HRESULT AppendHeader(char* key, char* value) = 0;
    virtual HRESULT AppendBody(void* data, int size, bool flush) = 0;
...
{
    virtual HRESULT OnRequest(IRequest*request, IResponse* responseBuilder) = 0;
};
...
extern const GUID IID_IResponse;
...
const GUID IID_IResponse = { 0x24e1a430, 0x27f6, 0x4fd4, { 0xa0, 0xa4, 0x95, 0xe9, 0xde, 0xa8, 0xd5, 0x1a } };
#endif
